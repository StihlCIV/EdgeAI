###########################################################################
## Makefile generated for component 'Predict0'. 
## 
## Makefile     : Predict0.mk
## Generated on : Wed Jul 16 10:28:18 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Predict0.exe
...
PRODUCT_NAME              = Predict0
MAKEFILE                  = Predict0.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/dx5entre/Documents/Spang/edge-ai/Matlab/TF
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Predict0_comp.rsp
CMD_FILE                  = Predict0.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Predict0.exe
...
DEFINES_STANDARD = -DMODEL=Predict0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Predict0_ert_rtw/Predict0.c

MAIN_SRC = $(START_DIR)/Predict0_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Predict0_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Predict0_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Predict0_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Predict0_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Predict0_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Predict0.obj : $(START_DIR)/Predict0_ert_rtw/Predict0.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/Predict0_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
